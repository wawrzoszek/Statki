...
public class Ship {
	...
	public void wpiszStatek(Plansza p, int rozmiarStatku) {
		...
		// czy nast«pny element statku nie wyjdzie za plansze, jeæli wyjdzie zaczyna od poczˆtku
		if (kierunek == 0) { 
		...
		if (poprawny_kierunek == true) {
			...
			for (int j = 0; j < rozmiarStatku; j++) {
				...
				try {
					// jesli na kt—rymæ z miejsc nowego statku na planszy jest juz statek wr— do poczˆtku
					...
					// jesli na kt—rymæ z miejsc obok nowego statku na planszy jest juz statek wr— do poczˆtku
